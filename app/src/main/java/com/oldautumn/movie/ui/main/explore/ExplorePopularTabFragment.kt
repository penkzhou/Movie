...
@AndroidEntryPoint
class ExplorePopularTabFragment : Fragment() {

    private val viewModel: ExplorePopularViewModel by viewModels()
            ...
            launchAndRepeatWithViewLifecycle(Lifecycle.State.STARTED) {
                viewModel.uiState.collect { uiState ->
                    if (uiState.errorMessage.isNotEmpty()) {
                        ...
                        if (uiState.popularCollectionList.isNotEmpty()) {
                            adapter.updateData(uiState.popularCollectionList)
                        }
                    }
                }
            }
