...
class ShowTrendingAdapter(private val popularList: MutableList<UnifyShowTrendingItem>) :
    RecyclerView.Adapter<ShowTrendingAdapter.PopularViewHolder>() {
    ...
    fun updateData(newPopularList: List<UnifyShowTrendingItem>) {
        popularList.clear()
    ...
    class PopularViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun updateViewWithItem(movieWithImage: UnifyShowTrendingItem) {
